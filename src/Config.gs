...
function setupJobsTab_(sheet) {
  ...
  const jobs = [
    [
      ...
      true,
      'MailBot/Urgent',
      'Analyze these emails for items requiring immediate attention TODAY.\n\nFlag as IMPORTANT only if you find:\n- Hard deadlines within 24 hours\n- Requests from executives or VIPs\n- System outages or critical errors\n- Time-sensitive decisions or approvals needed\n- Financial or legal matters with urgency\n\nNOT urgent (ignore these):\n- Routine requests and FYIs\n- Newsletters and promotions\n- Meeting invites for future dates\n- Status updates and reports\n- Automated notifications\n\nIf anything is urgent, briefly explain what and why. If nothing requires immediate action, respond with: "No urgent items found."',
      'interval',
      '5',
      'conditional',
      true,   // AutoLabel
